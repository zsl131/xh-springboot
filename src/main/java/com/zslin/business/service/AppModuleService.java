 ...
 */
@Service
@AdminAuth(name = "移动端首页大功能展示管理", psn = "移动端管理", orderNum = 2, type = "1", url = "/admin/appModule")
@Explain(name = "移动端首页大功能展示管理", notes = "移动端首页大功能展示管理")
public class AppModuleService {
    ...
    @ExplainOperation(name = "移动端首页大功能展示列表", notes = "移动端首页大功能展示列表", params= {
             ...
             @ExplainReturn(field = "size", type = "int", notes = "移动端首页大功能展示数量"),
             @ExplainReturn(field = "datas", type = "Object", notes = "移动端首页大功能展示数组对象")
     })
     public JsonResult list(String params) {
         QueryListDto qld = QueryTools.buildQueryListDto(params);
         Page<AppModule> res = appModuleDao.findAll(QueryTools.getInstance().buildSearch(qld.getConditionDtoList()),
                 SimplePageBuilder.generate(qld.getPage(), qld.getSize(), SimpleSortBuilder.generateSort(qld.getSort())));

         return JsonResult.getInstance().set("size", (int) res.getTotalElements()).set("datas", res.getContent());
     }

    @AdminAuth(name = "添加移动端首页大功能展示", orderNum = 2)
    @ExplainOperation(name = "添加移动端首页大功能展示", notes = "添加移动端首页大功能展示信息", params = {
            @ExplainParam(value = "id", name = "移动端首页大功能展示id", require = true, type = "int", example = "1"),
    ...
    @AdminAuth(name = "修改移动端首页大功能展示", orderNum = 3)
    @ExplainOperation(name = "修改移动端首页大功能展示", notes = "修改移动端首页大功能展示信息", params = {
            @ExplainParam(value = "id", name = "移动端首页大功能展示id", require = true, type = "int", example = "1"),
            @ExplainParam(value = "...", name = "其他信息", type = "Object", example = "对应其他数据")
    }, back = {
    ...
    public JsonResult update(String params) {
        try {
            ...
            AppModule obj = appModuleDao.findOne(o.getId());
    ...
    @AdminAuth(name = "获取移动端首页大功能展示", orderNum = 5)
    @ExplainOperation(name = "获取移动端首页大功能展示信息", notes = "通过ID获取角色对象", params = {
            @ExplainParam(value = "id", name = "移动端首页大功能展示ID", require = true, type = "int", example = "1")
    }, back = {
    ...
    public JsonResult loadOne(String params) {
        try {
            ...
            AppModule obj = appModuleDao.findOne(id);
            return JsonResult.getInstance().set("obj", obj);
        } catch (Exception e) {
            e.printStackTrace();
    ...
    @AdminAuth(name = "删除移动端首页大功能展示", orderNum = 4)
    @ExplainOperation(name = "删除移动端首页大功能展示", notes = "通过ID删除对象", params = {
    ...
    public JsonResult delete(String params) {
        try {
            Integer id = Integer.parseInt(JsonTools.getJsonParam(params, "id"));
            AppModule r = appModuleDao.findOne(id);
            appModuleDao.delete(r);
