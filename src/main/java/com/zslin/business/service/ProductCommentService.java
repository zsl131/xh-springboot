...
import com.zslin.business.dao.IProductCommentDao;
...
@Explain(name = "产品评论管理", notes = "产品评论管理")
public class ProductCommentService {
    ...
    public JsonResult update(String params) {
        try {
            ProductComment o = JSONObject.toJavaObject(JSON.parseObject(params), ProductComment.class);
            ...
            ProductComment obj = productCommentDao.findOne(o.getId());
    ...
    public JsonResult loadOne(String params) {
        try {
            ...
            ProductComment obj = productCommentDao.findOne(id);
            return JsonResult.getInstance().set("obj", obj);
        } catch (Exception e) {
            e.printStackTrace();
    ...
    @AdminAuth(name = "删除产品评论", orderNum = 4)
    @ExplainOperation(name = "删除产品评论", notes = "通过ID删除对象", params = {
    ...
    public JsonResult delete(String params) {
        try {
            Integer id = Integer.parseInt(JsonTools.getJsonParam(params, "id"));
            ProductComment r = productCommentDao.findOne(id);
            productCommentDao.delete(r);
